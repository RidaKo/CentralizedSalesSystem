...
namespace CentralizedSalesSystem.API.Migrations
{
    ...
    [Migration("20251218114808_AddItemVariationOptionToOrderItems")]
    partial class AddItemVariationOptionToOrderItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CentralizedSalesSystem.API.Models.Orders.OrderItem", b =>
                {
                    ...
                    b.Property<long?>("ItemVariationOptionId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("ItemVariationOptionId");
            ...
            modelBuilder.Entity("CentralizedSalesSystem.API.Models.Orders.OrderItem", b =>
                {
                    ...
                    b.HasOne("CentralizedSalesSystem.API.Models.Orders.ItemVariationOption", "ItemVariationOption")
                        .WithMany()
                        .HasForeignKey("ItemVariationOptionId");
                    ...
                    b.Navigation("ItemVariationOption");
